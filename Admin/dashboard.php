...
<body>    
    ...
    <div class="container my-5">
        <div class="row justify-content-center">
            <!-- Patients Management Box -->
            <div class="col-md-4">
                <div class="card navigation-card" style="height: 200px;">
                    <div class="card-body">
                        <h5 class="card-title">View Patient Details</h5>
                        <p class="card-text">Modify and view patient data.</p>
                        <a href="view_patient_info.php" class="btn btn-primary">Manage</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card navigation-card" style="height: 200px;">
                    <div class="card-body">
                        ...
                        <p class="card-text">add and view nurse data.</p>
                        <a href="manage_nurse.php" class="btn btn-primary">Manage</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card navigation-card" style="height: 200px;">
                    <div class="card-body">
                        ...
                        <p class="card-text">Update and manage vaccine information.</p>
                        <a href="manage_vaccine.php" class="btn btn-primary">Manage</a>
                    </div>
                </div>
            </div>
        </div>
